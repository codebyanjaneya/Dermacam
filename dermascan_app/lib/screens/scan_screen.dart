  ...
  Future<void> _analyze(File imageFile) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // ── Image quality errors from backend ──
        if (result['error'] == 'low_brightness') {
          if (!mounted) return;
          setState(() => _isAnalyzing = false);
          _showError('📸 Photo bahut dark hai! Natural light mein photo lo.');
          return;
        }
        if (result['error'] == 'overexposed') {
          if (!mounted) return;
          setState(() => _isAnalyzing = false);
          _showError('📸 Photo overexposed hai! Flash band karo.');
          return;
        }
      ...
      if (e.toString().contains('TimeoutException')) {
        _showError('⏱️ Request timed out. Dobara try karo.');
            ...
            child: Column(
              ...
              children: [
                ...
                _TipRow(
                  ...
                  text: 'Make sure you have internet',
                  color: const Color(0xFF34EDB3),
                ),
